...
const vinted = new Projet('Vinted','Vinted is a university project where we redesigned the Vinted site ourselves with almost all of its functions with a group of five students. We had to manage all aspects of rgpd and data security.','Today', '',['Laravel','css'])
