...
const ugur = new Projet('UGUR','UGUR is a video game made with Unity for a university project. We were a group of four students to make it in one week.','May 2024' ,'https://github.com/Shuuss/UGUR', ['Unity','c#'])
const lettricide = new Projet('Lettricide','Lettricide is a video game university project made with wpf in group of two.','December - January 2024', 'https://github.com/Simonftr/Lettricide',['c#','wpf'])
const botanic = new Projet('Botanic','Botanic was a simulation of a fake customer order from botanic to create an ERP for the manage of products.','December 2023', 'https://github.com/Jules123131212/SAE_Botanic',['c#','wpf'])
const vinted = new Projet('Vinted','Vinted is a university project where we redesigned the vinted site ourselves with almost all of its functions in group of 5. We had to manage all aspects of rgpd and data security.','Today', '',['Laravel','css'])
const scodoc = new Projet('Scodoc','Scodoc is a database we created for grade management. We needed to create some statistics with Power Bi.','March - May 2024', '',['postgresql','power bi'])
